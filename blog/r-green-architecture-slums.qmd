...
# Create radar chart for multi-benefit comparison
library(tidyr)
...
p8 <- ggplot(benefits_long, aes(x = benefit_type, y = score, group = intervention,
                               color = intervention)) +
  geom_line(size = 1) +
  geom_point(size = 3) +
  coord_polar() +
  labs(title = "Multi-Benefit Comparison of Green Interventions",
       x = "", y = "Benefit Score") +
  theme_minimal() +
