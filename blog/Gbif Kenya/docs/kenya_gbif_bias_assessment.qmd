...
# Reverse geocoding function using Photon API (OpenStreetMap)
# Returns a human-readable location name for given coordinates
reverse_geocode <- function(lon, lat) {
  ...
  tryCatch({
    ...
    if (length(response$features) > 0) {
      props <- response$features$properties[[1]]

      # Build location string from available components
      location_parts <- c()

      # Priority order: city/town/village > county/state > country
      if (!is.null(props$city)) {
        location_parts <- c(location_parts, props$city)
      } else if (!is.null(props$town)) {
        location_parts <- c(location_parts, props$town)
      } else if (!is.null(props$village)) {
        location_parts <- c(location_parts, props$village)
      } else if (!is.null(props$name)) {
        location_parts <- c(location_parts, props$name)
      }

      if (!is.null(props$county)) {
        location_parts <- c(location_parts, props$county)
      } else if (!is.null(props$state)) {
        location_parts <- c(location_parts, props$state)
      }

      if (!is.null(props$country)) {
        location_parts <- c(location_parts, props$country)
      }

      if (length(location_parts) > 0) {
        return(paste(location_parts, collapse = ", "))
      }
    }

    # Fallback to coordinates if no location found
    return(paste0("Near ", round(lat, 2), "°, ", round(lon, 2), "°"))

  }, error = function(e) {
    # On error, return coordinates
    return(paste0("Grid Cell (", round(lon, 2), "°, ", round(lat, 2), "°)"))
  })
}

# Batch reverse geocoding with rate limiting and caching
# Geocodes multiple locations with progress tracking
batch_reverse_geocode <- function(sf_data, delay = 0.5) {
  message("Starting batch reverse geocoding for ", nrow(sf_data), " grid cells...")

  # Calculate centroids
  centroids <- st_centroid(sf_data$geometry)
  coords <- st_coordinates(centroids)

  # Initialize location column
  locations <- character(nrow(sf_data))

  # Geocode with progress tracking
  for (i in 1:nrow(coords)) {
    if (i %% 10 == 0) {
      message("  Progress: ", i, "/", nrow(coords), " cells geocoded")
    }

    locations[i] <- reverse_geocode(coords[i, 1], coords[i, 2])
...
# Pre-compute reverse geocoded locations (with caching)
geocode_cache_file <- here("blog", "Gbif Kenya", "results", "spatial_bias", "geocoded_locations.rds")

if (file.exists(geocode_cache_file)) {
  # Load cached geocoded locations
  message("Loading cached reverse geocoded locations...")
  spatial_grid_wgs84$location_name <- readRDS(geocode_cache_file)
} else {
  # Compute reverse geocoded locations for all grid cells
  spatial_grid_wgs84$location_name <- batch_reverse_geocode(spatial_grid_wgs84, delay = 0.5)

  # Cache the results for future use
  saveRDS(spatial_grid_wgs84$location_name, geocode_cache_file)
  message("Geocoded locations cached to: ", geocode_cache_file)
}
...
leaflet(spatial_grid_wgs84) %>%
  ...
  addPolygons(
    ...
    popup = ~{
      ...
      paste0(
        "<div style='color: #ffa873 !important; font-family: Arial, sans-serif;'>",
        "<strong style='color: #ffa873 !important;'>Grid Cell Summary</strong><br>",
        "<strong style='color: #ffa873 !important;'>Longitude:</strong> ", round(coords[1], 4), "°<br>",
        "<strong style='color: #ffa873 !important;'>Latitude:</strong> ", round(coords[2], 4), "°<br>",
        "<strong style='color: #ffa873 !important;'>Location:</strong> ", location_name, "<br>",
        "<hr style='border-color: #ffa873 !important;'>",
        "<strong style='color: #ffa873 !important;'>Records:</strong> ", format(n_records, big.mark = ","), "<br>",
        "<strong style='color: #ffa873 !important;'>Species:</strong> ", n_species, "<br>",
        "<strong style='color: #ffa873 !important;'>Log10 Records:</strong> ", round(log10(n_records + 1), 2),
        "</div>"
      )
    },
...
if (file.exists(spatial_grid_file) && file.exists(grid_pred_file)) {
  ...
  # Add pre-computed reverse geocoded locations (load from cache if available)
  if (file.exists(geocode_cache_file)) {
    grid_wgs84$location_name <- readRDS(geocode_cache_file)[match(grid_wgs84$grid_id, spatial_grid$grid_id)]
  } else {
    # If cache doesn't exist, compute on the fly
    grid_wgs84$location_name <- batch_reverse_geocode(grid_wgs84, delay = 0.5)
  }
  ...
  leaflet(grid_wgs84) %>%
    ...
    addPolygons(
      ...
      popup = ~{
        ...
        paste0(
          "<div style='color: #ffa873 !important; font-family: Arial, sans-serif;'>",
          "<strong style='color: #ffa873 !important;'>Sampling Bias Analysis</strong><br>",
          "<strong style='color: #ffa873 !important;'>Longitude:</strong> ", round(coords[1], 4), "°<br>",
          "<strong style='color: #ffa873 !important;'>Latitude:</strong> ", round(coords[2], 4), "°<br>",
          "<strong style='color: #ffa873 !important;'>Location:</strong> ", location_name, "<br>",
          "<hr style='border-color: #ffa873 !important;'>",
          "<strong style='color: #ffa873 !important;'>Observed:</strong> ", format(n_records, big.mark = ","), " records<br>",
          "<strong style='color: #ffa873 !important;'>Predicted:</strong> ", format(round(predicted_count), big.mark = ","), " records<br>",
          "<strong style='color: #ffa873 !important;'>Residual:</strong> ", round(residual_count, 1), "<br>",
          "<strong style='color: #ffa873 !important;'>Std. Residual:</strong> ", round(residual_std, 2), "<br>",
          "<hr style='border-color: #ffa873 !important;'>",
          ifelse(residual_std < -1, "<strong style='color: #2166AC !important;'>Under-sampled</strong>",
                 ifelse(residual_std > 1, "<strong style='color: #B2182B !important;'>Over-sampled</strong>",
                        "<strong style='color: #ffa873 !important;'>As expected</strong>")),
          "</div>"
        )
      },
      highlightOptions = highlightOptions(
...
if (file.exists(spatial_grid_file) && file.exists(grid_pred_file)) {
  ...
  # Add pre-computed reverse geocoded locations (load from cache if available)
  if (file.exists(geocode_cache_file)) {
    grid_filtered_wgs84$location_name <- readRDS(geocode_cache_file)[match(grid_filtered_wgs84$grid_id, spatial_grid$grid_id)]
  } else {
    # If cache doesn't exist, compute on the fly
    grid_filtered_wgs84$location_name <- batch_reverse_geocode(grid_filtered_wgs84, delay = 0.5)
  }
  ...
  map_filtered <- leaflet(grid_filtered_wgs84) %>%
    ...
    addPolygons(
      ...
      popup = ~{
        ...
        paste0(
          "<div style='color: #ffa873 !important; font-family: Arial, sans-serif;'>",
          "<strong style='color: #ffa873 !important;'>Filtered Sampling Bias</strong><br>",
          "<strong style='color: #ffa873 !important;'>Longitude:</strong> ", round(coords[1], 4), "°<br>",
          "<strong style='color: #ffa873 !important;'>Latitude:</strong> ", round(coords[2], 4), "°<br>",
          "<strong style='color: #ffa873 !important;'>Location:</strong> ", location_name, "<br>",
          "<hr style='border-color: #ffa873 !important;'>",
          "<strong style='color: #ffa873 !important;'>Observed:</strong> ", format(n_records, big.mark = ","), " records<br>",
          "<strong style='color: #ffa873 !important;'>Predicted:</strong> ", format(round(predicted_count), big.mark = ","), " records<br>",
          "<strong style='color: #ffa873 !important;'>Residual:</strong> ", round(residual_filtered, 1), "<br>",
          "<strong style='color: #ffa873 !important;'>Std. Residual (filtered):</strong> ", round(residual_std_filtered, 2), "<br>",
          "<hr style='border-color: #ffa873 !important;'>",
          ifelse(residual_std_filtered < -1, "<strong style='color: #2166AC !important;'>Under-sampled</strong>",
                 ifelse(residual_std_filtered > 1, "<strong style='color: #B2182B !important;'>Over-sampled</strong>",
                        "<strong style='color: #ffa873 !important;'>As expected</strong>")),
          "</div>"
        )
      },
    ...
    addPolygons(
      ...
      popup = ~{
        ...
        paste0(
          ...
          "<strong style='color: #ffa873 !important;'>Species:</strong> ", n_species, "<br>",
          "<strong style='color: #ffa873 !important;'>Records:</strong> ", format(n_records, big.mark = ","), "<br>",
          "<strong style='color: #ffa873 !important;'>Log10 Species:</strong> ", round(log10(n_species + 1), 2),
          "</div>"
        )
      },
      highlightOptions = highlightOptions(
