...
# NOTE: Data files not included in repository - file checks and loading disabled
...
# Load data files
# NOTE FOR LEARNERS: Data loading disabled - RDS files not included in repository
...
# NOTE: Data files not included in repository - chunk disabled
...
```{r load-quality-data, eval=FALSE}
# Load comprehensive data quality assessment
# NOTE: Data loading disabled - quality_assessment not available
# quality_tracking <- quality_assessment$tracking
# coord_issues <- quality_assessment$coord_issues
# quality_metrics <- quality_assessment$metrics
```
...
```{r load-temporal-data, eval=FALSE}
### Data Flow Summary:
...
```{r load-taxonomic-data, eval=FALSE}
# NOTE: Data files not included in repository - chunk disabled
# taxonomic_summary <- readRDS(here("blog", "Gbif Kenya", "results", "taxonomic_bias", "taxonomic_bias_summary.rds"))
...
```{r fig-quality-summary, fig.cap="Comparison of filtering strategies showing the number of records that would be retained under different quality filtering approaches (minimal, moderate, strict). This demonstrates the flexibility of the flagging framework to support different analytical requirements while preserving all records with documented quality flags.", eval=FALSE, echo=FALSE}
# Note: Figure file not included in repository
