...
![Environmental protection concept. Photo by [Li-An Lim](https://unsplash.com/@li_anlim) on [Unsplash](https://unsplash.com/photos/ycW4YxhrWHM)](https://images.unsplash.com/photo-1569163139394-de4798aa62b5?w=1200&q=80)

Kenya's Environmental Impact Assessment (EIA) system, established under the [Environmental Management and Coordination Act (EMCA) of 1999](http://www.environment.go.ke/), represents a significant commitment to sustainable development. However, the state of data quality, accessibility, and reproducibility in EIA processes reveals substantial gaps that undermine the effectiveness of environmental governance (Kakonge, 2006).
...
![Governance and transparency. Photo by [Tingey Injury Law Firm](https://unsplash.com/@tingeyinjurylawfirm) on [Unsplash](https://unsplash.com/photos/L4YGuSg0fxs)](https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=1200&q=80)

Environmental Impact Assessments serve as crucial gatekeepers in Kenya's development trajectory, theoretically ensuring that economic progress does not come at the expense of environmental degradation. Since the passage of [EMCA in 1999](http://www.environment.go.ke/) and subsequent [EIA regulations in 2003](https://www.nema.go.ke/), Kenya has established a legal framework requiring systematic evaluation of proposed projects' environmental consequences. The [National Environment Management Authority (NEMA)](https://www.nema.go.ke/) oversees this process, reviewing thousands of EIA reports annually across three risk categories: low, medium, and high-risk projects.
...
Kenya's EIA framework mandates comprehensive baseline data collection across physical, biological, and socio-economic parameters. The regulations require EIA reports to document existing environmental conditions through systematic surveys of air quality, water resources, soil characteristics, biodiversity, and socio-economic factors. These baseline studies serve as reference points against which project impacts are measured.

The 2003 EIA regulations specify that reports must include evidence of public consultation, mitigation measures, and Environmental Management Plans (EMPs) with monitoring protocols. Projects require annual environmental audits to verify compliance with approved EMPs. On paper, this creates a data lifecycle from baseline assessment through ongoing monitoring—a framework that should enable reproducible science and adaptive management.

However, the gap between regulatory requirements and implementation reality is substantial.
...
<<<<<<< HEAD
![Open data concept. Photo by [Markus Spiske](https://unsplash.com/@markusspiske) on [Unsplash](https://unsplash.com/photos/iar-afB0QQw)](https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&q=80)

While Kenya launched the [Kenya Open Data Initiative](https://www.opendata.go.ke/) in 2011—becoming the first sub-Saharan African country to do so (Centre for Public Impact, 2024)—EIA data remains notably absent from this transparency effort. In fact, the opendata.go.ke portal itself has faced significant accessibility challenges, [being offline for several years](/blog/kenya-open-data-initiative.qmd) due to institutional and resource constraints. NEMA maintains that EIA reports are publicly accessible, but the reality presents significant barriers.
...
![Corruption and governance. Photo by [Christian Lue](https://unsplash.com/@christianlue) on [Unsplash](https://unsplash.com/photos/-70vEbVYh6Y)](https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1200&q=80)
...
1. Centre for Public Impact. (2024). *Kenya Open Data Initiative*. Retrieved from [https://www.centreforpublicimpact.org/case-study/open-data-kenya](https://www.centreforpublicimpact.org/case-study/open-data-kenya)

2. Constitution of Kenya. (2010). *Article 35: Access to information*. Retrieved from [http://www.kenyalaw.org/](http://www.kenyalaw.org/)

3. Enríquez-de-Salamanca, Á. (2018). Stakeholders' manipulation of Environmental Impact Assessment. *Environmental Impact Assessment Review*, 68, 10-18. [https://doi.org/10.1016/j.eiar.2017.10.003](https://doi.org/10.1016/j.eiar.2017.10.003)

4. Global Data Barometer. (2022). *Kenya country assessment*. Retrieved from [https://globaldatabarometer.org/](https://globaldatabarometer.org/)

5. Government of Kenya. (1999). *Environmental Management and Coordination Act (EMCA)*. Retrieved from [http://www.environment.go.ke/](http://www.environment.go.ke/)

6. Government of Kenya. (2003). *Environmental Management and Coordination (Impact Assessment and Audit) Regulations*. Retrieved from [https://www.nema.go.ke/](https://www.nema.go.ke/)

7. Kakonge, J. O. (2006). Environmental planning and management: A practical guide. *African Centre for Technology Studies Press*.

8. Kenya National Bureau of Statistics. (2023). *National Ethics and Corruption Survey Report*. Retrieved from [https://www.knbs.or.ke/](https://www.knbs.or.ke/)

9. National Environment Management Authority (NEMA). (2024). *Official resources and guidelines*. Retrieved from [https://www.nema.go.ke/](https://www.nema.go.ke/)

10. Open Government Partnership. (2023). *Kenya Action Plan 2023-2027*. Retrieved from [https://www.opengovpartnership.org/](https://www.opengovpartnership.org/)

11. Transparency International. (2024). *Corruption Perceptions Index 2024*. Retrieved from [https://www.transparency.org/en/cpi/2024](https://www.transparency.org/en/cpi/2024)

12. Transparency International Kenya. (2023). *Environmental Impact Assessment Handbook*. Retrieved from [https://tikenya.org/](https://tikenya.org/)
