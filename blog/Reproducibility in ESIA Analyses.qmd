...
While Kenya launched the [Kenya Open Data Initiative](https://www.opendata.go.ke/) in 2011—becoming the first sub-Saharan African country to do so (Centre for Public Impact, 2024)—EIA data remains notably absent from this transparency effort. [NEMA](https://www.nema.go.ke/) maintains that EIA reports are publicly accessible, but the reality presents significant barriers.
