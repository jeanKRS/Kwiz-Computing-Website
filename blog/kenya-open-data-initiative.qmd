...
As discussed in our [analysis of Kenya's Environmental Impact Assessment system](/blog/Reproducibility%20in%20ESIA%20Analyses.qmd), environmental data remains particularly inaccessible. Despite Kenya's pioneering open data initiative, **EIA data is notably absent** from transparency efforts.
...
**Data quality requires investment**: Publishing data is not enough; it must be current, complete, and usable
...
- **Environmental data**: Supporting climate action and impact monitoring
